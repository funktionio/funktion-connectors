...
/**
 */
public class FilterLanguageTest extends FunktionTestSupport {
    ...
    private static final transient Logger LOG = LoggerFactory.getLogger(FilterLanguageTest.class);
    ...
    protected void addFunktionFlows(Funktion funktion) {
        ...
        flow.filter("${body} contains 'James'", "simple").endpoint(MATCHED_URI);
